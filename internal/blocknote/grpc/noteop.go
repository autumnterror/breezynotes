...
func (s *ServerAPI) ChangeTitleNote(ctx context.Context, req *brzrpc2.ChangeTitleNoteRequest) (*emptypb.Empty, error) {
...
func (s *ServerAPI) GetNote(ctx context.Context, req *brzrpc2.NoteId) (*brzrpc2.Note, error) {
	...
	return res.(*brzrpc2.Note), nil
}

func (s *ServerAPI) GetAllNotes(ctx context.Context, req *brzrpc2.UserId) (*brzrpc2.NoteParts, error) {
	...
	return res.(*brzrpc2.NoteParts), nil
}

func (s *ServerAPI) GetNotesByTag(ctx context.Context, req *brzrpc2.UserTagId) (*brzrpc2.NoteParts, error) {
...
func (s *ServerAPI) CreateNote(ctx context.Context, req *brzrpc2.Note) (*emptypb.Empty, error) {
...
func (s *ServerAPI) GetAllBlocksInNote(ctx context.Context, req *brzrpc2.Strings) (*brzrpc2.Blocks, error) {
	...
	return &brzrpc2.Blocks{Items: res.([]*brzrpc2.Block)}, nil
}

func (s *ServerAPI) AddTagToNote(ctx context.Context, req *brzrpc2.NoteTagId) (*emptypb.Empty, error) {
...
func (s *ServerAPI) RemoveTagFromNote(ctx context.Context, req *brzrpc2.NoteTagId) (*emptypb.Empty, error) {
...
func (s *ServerAPI) ChangeBlockOrder(ctx context.Context, req *brzrpc2.ChangeBlockOrderRequest) (*emptypb.Empty, error) {
