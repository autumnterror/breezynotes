...
func TestOp(t *testing.T) {
	...
	t.Run("change_text", func(t *testing.T) {
		...
		if assert.NoError(t, err) {
			...
			block.Data = s
			qb, _ := domainblocks.FromUnifiedToQuoteBlock(block)
...
func TestChangeType(t *testing.T) {
	...
	t.Run(domainblocks.TextBlockType, func(t *testing.T) {
		block := testBlock()
		qt, _ := domainblocks.FromUnifiedToQuoteBlock(block)
		...
		assert.Equal(t, qt.Data.Text, tb.Data.TextData.PlainText())
	})
...
func TestChangeTypeNil(t *testing.T) {
	...
	t.Run(domainblocks.TextBlockType, func(t *testing.T) {
		...
		tb, err := domainblocks.FromUnifiedToTextBlock(block)
		assert.NoError(t, err)
		assert.Equal(t, "", tb.Data.TextData.PlainText())
	})
...
func testBlock() *brzrpc.Block {
	qb := domainblocks.QuoteBlock{
		Id:   "test_quote",
		Type: domainblocks.QuoteBlockType,
		Data: &domainblocks.QuoteData{
			Text: testText,
		},
	}
	unif, _ := qb.ToUnified()
