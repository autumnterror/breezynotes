...
func applyStyleOp(b *domain.HeaderBlock, raw []byte) (map[string]any, error) {
	if b.Data == nil {
		return nil, nil
	}
...
func insertTextOp(b *domain.HeaderBlock, raw []byte) (map[string]any, error) {
	if b.Data == nil {
		return nil, nil
	}
	if b.Data.TextData == nil {
...
func deleteRangeOp(b *domain.HeaderBlock, raw []byte) (map[string]any, error) {
	if b.Data == nil {
		return nil, nil
	}
	if b.Data.TextData == nil {
...
func changeLevel(b *domain.HeaderBlock, raw []byte) (map[string]any, error) {
	if b.Data == nil {
		return nil, nil
	}
