...
func applyStyleOp(b *domain.TextBlock, raw []byte) (map[string]any, error) {
	if b.Data == nil {
		return nil, nil
	}
	var req struct {
...
func insertTextOp(b *domain.TextBlock, raw []byte) (map[string]any, error) {
	if b.Data == nil {
		return nil, nil
	}
	var req struct {
...
func deleteRangeOp(b *domain.TextBlock, raw []byte) (map[string]any, error) {
	if b.Data == nil {
		return nil, nil
	}
	var req struct {
