...
func applyStyleOp(b *domain.ListBlock, raw []byte) (map[string]any, error) {
	if b.Data == nil {
		return nil, nil
	}
...
func insertTextOp(b *domain.ListBlock, raw []byte) (map[string]any, error) {
	if b.Data == nil {
		return nil, nil
	}
	if b.Data.TextData == nil {
...
func deleteRangeOp(b *domain.ListBlock, raw []byte) (map[string]any, error) {
	if b.Data == nil {
		return nil, nil
	}
	if b.Data.TextData == nil {
...
func changeType(b *domain.ListBlock, raw []byte) (map[string]any, error) {
	if b.Data == nil {
		return nil, nil
	}
...
func changeValue(b *domain.ListBlock, raw []byte) (map[string]any, error) {
	if b.Data == nil {
		return nil, nil
	}
	var req struct {
...
func changeLevel(b *domain.ListBlock, raw []byte) (map[string]any, error) {
	if b.Data == nil {
		return nil, nil
	}
