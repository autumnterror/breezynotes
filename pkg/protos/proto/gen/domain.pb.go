...
var file_domain_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
...
var file_domain_proto_depIdxs = []int32{
	...
	9,  // 2: brz.NotePart.tag:type_name -> brz.Tag
	10, // 3: brz.Blocks.items:type_name -> brz.Block
	11, // 4: brz.Notes.items:type_name -> brz.Note
	12, // 5: brz.NoteParts.items:type_name -> brz.NotePart
	9,  // 6: brz.Tags.items:type_name -> brz.Tag
